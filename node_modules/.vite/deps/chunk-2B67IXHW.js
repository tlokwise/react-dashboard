...
var context = React7.createContext(null);
...
var NavItem2 = React8.forwardRef(({
  className,
  bsPrefix,
  as: Component = "div",
  ...props
...
var Anchor = React9.forwardRef((_ref, ref) => {
  let {
    onKeyDown
...
var Nav2 = React11.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
  ...
  let isNavbar = false;
  const navbarContext = (0, import_react13.useContext)(NavbarContext_default);
  const cardHeaderContext = (0, import_react13.useContext)(CardHeaderContext_default);
  if (navbarContext) {
...
//# sourceMappingURL=chunk-2B67IXHW.js.map
