...
import {
  ...
  useMounted,
  usePrevious
} from "./chunk-WCXBLJN3.js";
import {
  Button_default as Button_default2
} from "./chunk-G4L6COWE.js";
import {
  Button_default
} from "./chunk-5CHOVRPK.js";
import {
  CardBody_default,
  CardFooter_default,
  CardHeader_default,
...
var BreadcrumbItem = React14.forwardRef(({
  ...
  return (0, import_jsx_runtime13.jsx)(Component2, {
    ...
    children: active ? children : (0, import_jsx_runtime13.jsx)(LinkComponent, {
      ...linkProps,
      href,
      title,
      target,
...
var Breadcrumb = React15.forwardRef(({
  ...
  return (0, import_jsx_runtime14.jsx)(Component2, {
    ...
    ref,
    ...props,
    children: (0, import_jsx_runtime14.jsx)("ol", {
      ...listProps,
...
var CardGroup = React18.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var CarouselCaption = React19.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
function map(children, func) {
  let index = 0;
  return React21.Children.map(children, (child) => React21.isValidElement(child) ? func(child, index++) : child);
}
...
function hasChildOfType(children, type) {
  return React21.Children.toArray(children).some((child) => React21.isValidElement(child) && child.type === type);
}
    ...
    children: [indicators && (0, import_jsx_runtime20.jsx)("div", {
      ...
      children: map(children, (child, index) => {
        ...
        return slide ? (0, import_jsx_runtime20.jsx)(TransitionWrapper_default, {
          ...
          addEndListener: transitionEndListener,
          children: (status, innerProps) => React22.cloneElement(child, {
            ...innerProps,
...
var Container = React24.forwardRef(({
  bsPrefix,
  fluid = false,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component2 = "div",
...
var DropdownContext = React25.createContext(null);
...
function DropdownToggle({
  ...
  return (0, import_jsx_runtime28.jsx)(import_jsx_runtime27.Fragment, {
    children: children(props, meta)
  });
}
...
var DropdownItem = React28.forwardRef((_ref, ref) => {
  let {
    eventKey,
    disabled,
    onClick,
  ...
  return (0, import_jsx_runtime29.jsx)(Component2, Object.assign({}, props, {
    ref
  }, dropdownItemProps));
});
...
function Dropdown({
  ...
  return (0, import_jsx_runtime30.jsx)(SelectableContext_default.Provider, {
    value: handleSelect,
    children: (0, import_jsx_runtime30.jsx)(DropdownContext_default.Provider, {
      value: context4,
      children
    })
  });
...
var DropdownContext2 = React30.createContext({});
...
var DropdownDivider = React31.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "hr",
  role = "separator",
...
var DropdownHeader = React32.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  role = "heading",
...
var DropdownItem2 = React33.forwardRef(({
  bsPrefix,
  className,
  eventKey,
  disabled = false,
...
var DropdownItemText = React34.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var context3 = React35.createContext(null);
...
var DropdownMenu2 = React36.forwardRef(({
  bsPrefix,
  className,
  align,
  rootCloseEvent,
...
var DropdownToggle2 = React37.forwardRef(({
  bsPrefix,
  split,
  className,
  childBsPrefix,
...
var Dropdown2 = React38.forwardRef((pProps, ref) => {
  const {
    bsPrefix,
    drop = "down",
    show,
  ...
  return (0, import_jsx_runtime37.jsx)(DropdownContext_default2.Provider, {
    ...
    children: (0, import_jsx_runtime37.jsx)(Dropdown_default, {
      ...
      children: isInputGroup ? props.children : (0, import_jsx_runtime37.jsx)(Component2, {
        ...props,
        ref,
...
var DropdownButton = React39.forwardRef(({
  title,
  children,
  bsPrefix,
  rootCloseEvent,
  ...
  flip: flip2,
  ...props
}, ref) => (0, import_jsx_runtime39.jsxs)(Dropdown_default2, {
  ref,
  ...props,
...
var FigureImage = React41.forwardRef(({
  className,
  fluid = true,
  ...props
...
var FigureCaption = React42.forwardRef(({
  className,
  bsPrefix,
...
var Feedback = React44.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    as: Component2 = "div",
    className,
...
var FormCheckInput = React46.forwardRef(({
  id,
  bsPrefix,
  className,
  type = "checkbox",
...
var FormCheckLabel = React47.forwardRef(({
  bsPrefix,
  className,
  htmlFor,
  ...props
...
var FormCheck = React48.forwardRef(({
  id,
  bsPrefix,
  bsSwitchPrefix,
  inline = false,
...
var FormFloating = React50.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var FormGroup = React51.forwardRef(({
  controlId,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component2 = "div",
  ...props
  ...
  return (0, import_jsx_runtime52.jsx)(FormContext_default.Provider, {
    value: context4,
...
var FormLabel = React52.forwardRef(({
  ...
  htmlFor = htmlFor || controlId;
  if (column)
    return (0, import_jsx_runtime53.jsx)(Col_default, {
      ref,
      as: "label",
      className: classes,
      htmlFor,
  ...
  return (
    ...
    (0, import_jsx_runtime53.jsx)(Component2, {
      ref,
      className: classes,
      htmlFor,
      ...props
...
var FormRange = React53.forwardRef(({
  bsPrefix,
  className,
  id,
  ...props
  ...
  return (0, import_jsx_runtime54.jsx)("input", {
    ...props,
    type: "range",
    ref,
...
var FormSelect = React54.forwardRef(({
  bsPrefix,
  size,
  htmlSize,
  className,
  ...
  return (0, import_jsx_runtime55.jsx)("select", {
    ...props,
    size: htmlSize,
    ref,
...
var FormText = React55.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    bsPrefix,
    className,
...
var Switch = React56.forwardRef((props, ref) => (0, import_jsx_runtime57.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var FloatingLabel = React57.forwardRef(({
  bsPrefix,
  className,
  children,
  controlId,
  ...
  bsPrefix = useBootstrapPrefix(bsPrefix, "form-floating");
  return (0, import_jsx_runtime59.jsxs)(FormGroup_default, {
    ref,
    className: (0, import_classnames43.default)(className, bsPrefix),
    controlId,
    ...props,
    children: [children, (0, import_jsx_runtime58.jsx)("label", {
      htmlFor: controlId,
      children: label
    })]
  });
...
var InputGroupText = React59.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var InputGroupCheckbox = (props) => (0, import_jsx_runtime62.jsx)(InputGroupText_default, {
  children: (0, import_jsx_runtime62.jsx)(FormCheckInput_default, {
    type: "checkbox",
    ...props
  })
});
var InputGroupRadio = (props) => (0, import_jsx_runtime62.jsx)(InputGroupText_default, {
  children: (0, import_jsx_runtime62.jsx)(FormCheckInput_default, {
    type: "radio",
    ...props
  })
});
var InputGroup = React60.forwardRef(({
  bsPrefix,
  size,
  hasValidation,
  className,
  ...
  return (0, import_jsx_runtime62.jsx)(InputGroupContext_default.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime62.jsx)(Component2, {
      ref,
      ...props,
...
var ListGroupItem = React61.forwardRef(({
  bsPrefix,
  active,
  disabled,
  eventKey,
...
var ListGroup = React62.forwardRef((props, ref) => {
  const {
    className,
...
var Offcanvas = React70.forwardRef(({
  ...
  const {
    onToggle
  } = (0, import_react36.useContext)(NavbarContext_default) || {};
  ...
  const renderBackdrop = (0, import_react36.useCallback)((backdropProps) => (0, import_jsx_runtime72.jsx)("div", {
    ...backdropProps,
...
var Popover = React79.forwardRef(({
  ...
  return (0, import_jsx_runtime83.jsxs)("div", {
    ...
    className: (0, import_classnames61.default)(className, decoratedBsPrefix, primaryPlacement && `bs-popover-${bsDirection}`),
    ...props,
...
function useOverlayOffset(customOffset) {
  ...
  const offset2 = (0, import_react41.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
  ...
  return (0, import_jsx_runtime86.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React81.cloneElement(overlay, {
        ...
        popper: popper2,
        hasDoneInitialMeasure,
        className: (0, import_classnames63.default)(overlay.props.className, !transition && show && "show"),
        style: {
          ...overlay.props.style,
          ...overlayProps.style
        }
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime89.jsxs)(import_jsx_runtime88.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react43.cloneElement)(children, triggerProps), (0, import_jsx_runtime87.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var PageItem = React83.forwardRef(({
  ...
  return (0, import_jsx_runtime90.jsx)("li", {
    ref,
    style,
    className: (0, import_classnames64.default)(className, "page-item", {
      active,
      disabled
    }),
    children: (0, import_jsx_runtime91.jsxs)(Component2, {
      className: (0, import_classnames64.default)("page-link", linkClassName),
      style: linkStyle,
      ...props,
...
var Pagination = React84.forwardRef(({
  ...
  return (0, import_jsx_runtime92.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames65.default)(className, decoratedBsPrefix, size && `${decoratedBsPrefix}-${size}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames66.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size && `${bsPrefix}-${size}`, bg && `bg-${bg}`)
  };
}
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime95.jsx)("div", {
    ...
    ...props,
    role: "progressbar",
    className: (0, import_classnames67.default)(className, `${bsPrefix}-bar`, {
      [`bg-${variant}`]: variant,
...
var Ratio = React88.forwardRef(({
  ...
  return (0, import_jsx_runtime96.jsx)("div", {
    ...
    className: (0, import_classnames68.default)(bsPrefix, className, !isCustomRatio && `${bsPrefix}-${aspectRatio}`),
...
var Row = React89.forwardRef(({
  ...
  return (0, import_jsx_runtime97.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames69.default)(className, decoratedBsPrefix, ...classes)
  });
});
Row.displayName = "Row";
var Row_default = Row;
...
var Spinner = React90.forwardRef(({
  ...
  return (0, import_jsx_runtime98.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames70.default)(className, bsSpinnerPrefix, size && `${bsSpinnerPrefix}-${size}`, variant && `text-${variant}`)
  });
});
...
var Stack = React92.forwardRef(({
  ...
  return (0, import_jsx_runtime101.jsx)(Component2, {
    ...props,
    ref,
    className: (0, import_classnames71.default)(className, bsPrefix, ...createUtilityClassName({
      gap
    ...
    children: (0, import_jsx_runtime106.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime106.jsx)(Transition, {
        ...
        children: (0, import_jsx_runtime106.jsx)(Component2, {
          ...rest,
          ref,
          className: (0, import_classnames73.default)(className, prefix, isActive && "active")
        })
      })
    })
  });
...
var ToastFade = React99.forwardRef((props, ref) => (0, import_jsx_runtime109.jsx)(Fade_default, {
  ...props,
  ref,
