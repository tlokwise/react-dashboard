...
var ModalHeader = React13.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var ModalTitle = React14.forwardRef(({
  className,
  bsPrefix,
...
var Modal2 = React15.forwardRef(({
  ...
  const [modalStyle, setStyle] = (0, import_react13.useState)({});
  const [animateStaticModal, setAnimateStaticModal] = (0, import_react13.useState)(false);
  const waitingForMouseUpRef = (0, import_react13.useRef)(false);
  const ignoreBackdropClickRef = (0, import_react13.useRef)(false);
  const removeStaticModalAnimationRef = (0, import_react13.useRef)(null);
...
//# sourceMappingURL=chunk-KFIPOVZX.js.map
